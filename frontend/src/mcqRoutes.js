...
function MCQTest() {
  ...
  const generateMCQ = async () => {
    ...
    console.log("Selected Language Frontend:", language);
    ...
    try {
      ...
      console.log(error);
      alert("Backend server start karo.");
    } finally {
      setLoading(false);
    }
  };
  ...
  return (
    <div className="mcq-page">
      ...
      <section className="mcq-hero">
        <div className="mcq-hero-left">
          ...
          <p className="mcq-desc">
            Apna topic, question count aur language select karo. AI selected
            language me MCQ test generate karega.
          </p>
      ...
      {loading && <div className="loading-box">⚡ AI MCQ Generate Kar Raha Hai...</div>}
